...
public class TestPicActivity extends Activity
{
	...
	List<com.example.testpic.ImageBucket> dataList;
	GridView gridView;
	com.example.testpic.ImageBucketAdapter adapter;// 自定义的适配器
	com.example.testpic.AlbumHelper helper;
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		helper = com.example.testpic.AlbumHelper.getHelper();
